...
> Bản Windows của [Terminal Control Center (TCC)](https://github.com/nicebug/terminal-control-center) — ứng dụng web quản lý phiên terminal Windows qua trình duyệt, sử dụng ConPTY + xterm.js.
...
- **Giải pháp bền vững**: Chạy WTCC như **Windows Service** (qua nssm) với auto-restart để phiên tồn tại qua logout/reboot.
...
Service sẽ tự khởi động cùng Windows, đảm bảo phiên terminal tồn tại qua logout/reboot.
...
Xem thêm: [node-pty README](https://github.com/nicebug/node-pty#windows)
